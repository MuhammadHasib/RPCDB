...
def dateSets(YYYY,M1,YYYY2, M2 ):
  ...
  #DHMS2 = ".30+12%3A40%3A09"#".10%%2000:00:00"
  DHMS2 = ".01+12%3A40%3A09"#".20%%2000:00:00"
  ...
  for i in range(0, (YY3*12)+(M2-M1)+1 ): 
    ...
    dateSet.append( "beginDate="+MM1+DHMS1+"\&endDate="+MM2+DHMS2+"\&" )
...
for j,dateSet in enumerate(DateSets):
  ...
  for i,e in enumerate(disk):
    output1 = "HV_"+e+"_2015_"+str(j)+".txt"
    output2 = "HI_"+e+"_2015_"+str(j)+".txt"
